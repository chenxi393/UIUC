...
class BinaryTree
{
  ...
  private:
    ...
    void isOrdered(Node* subRoot,vector<T>& a) const;
    void printPaths(Node* subRoot,vector<vector<T> > &paths,vector<T> &NowPaths) const;
    int subDistances(Node* subRoot,int nowdistance) const;
    /**
